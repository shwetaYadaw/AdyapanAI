...
async function verify() {
  console.log('🔧 Verifying Equilibrium Index problem...\n');

  // Check for old problem
  const oldResult = await makeRequest('/api/v1/challenges/questions/finding-equilibrium-index-of-an-array-tcs-nqt');
  
  // Check for new problem
  const newResult = await makeRequest('/api/v1/challenges/questions/equilibrium-index-tcs-nqt');
