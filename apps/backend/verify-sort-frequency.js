...
async function verify() {
  console.log('🔧 Verifying Sort elements by frequency problem...\n');

  // Check for old problem
  const oldResult = await makeRequest('/api/v1/challenges/questions/sorting-elements-of-an-array-by-frequency-tcs-nqt');
  
  // Check for new problem
  const newResult = await makeRequest('/api/v1/challenges/questions/sort-elements-by-frequency-tcs-nqt');
