...
async function verify() {
  console.log('🔧 Verifying Maximum Product Subarray problem...\n');

  // Check for old problem
  const oldResult = await makeRequest('/api/v1/challenges/questions/maximum-product-subarray-in-an-array-tcs-nqt');
  
  // Check for new problem
  const newResult = await makeRequest('/api/v1/challenges/questions/maximum-product-subarray-tcs-nqt');
