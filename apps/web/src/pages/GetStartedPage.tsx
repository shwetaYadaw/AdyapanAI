...
export default function GetStartedPage() {
  ...
  const features = [
    { icon: Book, title: 'Exam Focused Material', subtitle: 'Curated by Experts' },
    { icon: Brain, title: 'Concept Based Learning', subtitle: 'Understand Deeply' },
    { icon: Zap, title: 'Practice More', subtitle: 'Improve Continuously' },
    { icon: Trophy, title: 'Achieve Your Goals', subtitle: 'We Help You Succeed' },
  ];
