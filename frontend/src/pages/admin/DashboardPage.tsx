...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50/40 via-white to-amber-50/30 dark:from-gray-950 dark:via-gray-950 dark:to-gray-950 p-5 lg:p-8">
